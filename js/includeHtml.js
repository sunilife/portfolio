	...
	document.write(`
		...
		<div class="modal-wrapper" style="display:none;">
			<div class="modal">
				<div class="conts">
					<div class="m-head">
						<h2>Basic Style Guide</h2>
						<button type="button" class="btn_close"><img src="img/bx.png"/></button>
						<hr/>
					</div>
					<div class="page">
						<img src="img/style_guide.svg" style="width:100%;" />
					</div>
				</div>
			</div>
		</div>

		<div class="modal-wrapper_01" style="display:none;">
			<div class="modal">
				<div class="conts">
					<div class="m-head">
						<h2>Basic Style Guide</h2>
					...
					<div class="page">
						<img src="img/modal_01.svg" style="width:100%;" />
					</div>
				</div>
			</div>
		</div>

		<div class="modal-wrapper_02" style="display:none;">
			<div class="modal">
				<div class="conts">
					<div class="m-head">
						<h2>Basic Style Guide</h2>
					...
					<div class="page">
						<img src="img/modal_02.svg" style="width:100%;" />
					</div>
				</div>
			</div>
		</div>

		<div class="modal-wrapper_03" style="display:none;">
			<div class="modal">
				<div class="conts">
					<div class="m-head">
						<h2>Basic Style Guide</h2>
					...
					<div class="page">
						<img src="img/modal_03.svg" style="width:100%;" />
					</div>
				</div>
			</div>
		</div>
